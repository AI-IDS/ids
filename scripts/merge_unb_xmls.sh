#!/bin/bash
# UNB ISCX dataset XML label file merger
# http://www.unb.ca/research/iscx/dataset/iscx-dataset.html

# Usage printer
function usage {
  echo "UNB ISCX dataset XML label file merger"
  echo "  Merges XMLs for one day to one"
  echo
  echo "Usage: $0 XML_PREFIX [XML_SUFFIX] [OUTPUT_FILE]"
  echo "Example:"
